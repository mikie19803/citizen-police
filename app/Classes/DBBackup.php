...
//these aren't used ...
        ...
        $this->dsn = $this->driver.':host='.$this->host.';port:3306;dbname='.$this->dbName;
    ...
    private function connect(){
        try {
            ...
            //these are the connection parameters used.
            ...
            $this->handler = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
