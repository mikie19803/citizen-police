...
@section('content')
  ...
  background-size:100% 100%">
            ...
            <div class="login-content">
                <div class="">
                    <a href="{{url('/password/reset')}}" class="btn btn-block btn-blue">Reset Through Email</a>

                     <br/>
                    <br/>  </div>
            </div>

                <p class="description">Enter your phone number, and we will send the reset code.</p>
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ url('password/reset/phone') }}">
                    ...
                    <div class="form-forgotpassword-success"><i class="entypo-check"></i>
                        <h3>Reset code has been sent.</h3>
                        <p>Please check your phone.</p></div>
